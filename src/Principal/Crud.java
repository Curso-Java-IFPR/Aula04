...
public class Crud {
    ...
    //Variável principal da conexão MySQL. É a classe que representa a conexão com o bando de dados
    private static Connection connection;

    public static void main(String[] args) {

        //o try/catch serve para tratamento de exceções, tratamento de códigos que podem não ser totalmente atendidos e gerarem alguma exceção/erro.
        ...
        try{
            ...
            //Dentro do getConnection é especificado o driver JDBC específico, neste caso utilizaremos o mysql
            //depois especificamos o local que está o banco de dados e o nome do banco (localhost:3306/test), os outros dois parametros são o usuario (root) e senha (neste caso esta vazia)
            ...
            stm.executeUpdate();
            //catch = se o que o try tentou não der certo, ele executa oque está dentro do catch.
    ...
    private static void atualizarVeiculo(int codigo, String modelo, String cor) {
        try {
            ...
            //se o codigo for igual a 3 ele vai alterar o modelo e a cor passado no parâmetro
            PreparedStatement stm = connection.prepareStatement(
    ...
    private static void mostrarVeiculos() {
        try {
            ...
            //enquanto o resultado(resultset) tiver algum dado, ou tiver um próximo dado, as linhas dentro do laço while serão executadas.
    ...
    private static boolean temVeiculo(int codigo) {
        try {
            //pega todos os registros da tabela veiculos, que o código seja igual ao do parâmetro.
            PreparedStatement stm = connection.prepareStatement(
